...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<DataSource> adapter = new NavigationSpinnerAdapter<>(this, R.layout.nav_spinner_item, NFCRegister.DATA_SOURCES);
        adapter.setDropDownViewResource(R.layout.view_drop_down);
        spinner.setAdapter(adapter);
        spinner.setSelection(positionOfSpinner = NFCRegister.DATA_SOURCES.indexOf(NFCRegister.getDataSource()));
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                final DataSource newSource = NFCRegister.DATA_SOURCES.get(position);
                if (newSource.equals(NFCRegister.getDataSource())) {
                    return;
                }
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                NFCRegister.CONFIGURATIONS.setDataSource(newSource);
                                NFCRegister.CONFIGURATIONS.save();
                                restart();
                            }
                        })
